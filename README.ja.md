...
この拡張機能で使用している VRChat API は[非公式なドキュメント](https://vrchatapi.github.io/) に基づくものであり、公式にこのAPIへのアクセスが認められているか不明であるため、このアプリの使用は自己責任で行ってください。  
この拡張機能を利用して発生したいかなる損害も開発者は一切の責任を負いかねます。
